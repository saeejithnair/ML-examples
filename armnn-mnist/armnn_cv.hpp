...
#include "InferenceTestImage.cpp"

#define ArmnnImage InferenceTestImage
...
/*// Helper struct for loading data
struct ArcImage
{
...
std::unique_ptr<ArcImage> loadImage(std::string dataDir, int image)
{
